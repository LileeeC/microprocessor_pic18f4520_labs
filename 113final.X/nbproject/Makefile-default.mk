...
SOURCEFILES_QUOTED_IF_SPACED=3b.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/3b.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/3b.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/3b.p1
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/3b.p1: 3b.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/3b.p1.d 
	@${RM} ${OBJECTDIR}/3b.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/3b.p1 3b.c 
	@-${MV} ${OBJECTDIR}/3b.d ${OBJECTDIR}/3b.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/3b.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
